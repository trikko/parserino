...
const(lxb_char_t)* lxb_css_syntax_state_comment(lxb_css_syntax_tokenizer_t* tkz, lxb_css_syntax_token_t* token, const(lxb_char_t)* data, const(lxb_char_t)* end)
{
    ...
    while (data < end) {
        switch (*data) {
            ...
            default:
                if (*data >= 0x80) {
                    lxb_codepoint_t cp = lxb_css_syntax_state_decode_utf_8_up_80(&data, end); if (cp == LXB_CSS_SYNTAX_ERROR_CODEPOINT) { do { if ((data - begin) > 0) { lxb_status_t status = lxb_css_syntax_string_append(tkz, cast(const(lxb_char_t)*) (begin), data - begin); if (status != LXB_STATUS_OK) { return null; } } } while (0); do { if ((lxb_css_syntax_replacement_length) > 0) { lxb_status_t status = lxb_css_syntax_string_append(tkz, cast(const(lxb_char_t)*) ("\uFFFD"), lxb_css_syntax_replacement_length); if (status != LXB_STATUS_OK) { return null; } } } while (0); data += 1; begin = data; } else if (cp >= 0xD800 && cp <= 0xDFFF) { do { if (((data - begin) - 3) > 0) { lxb_status_t status = lxb_css_syntax_string_append(tkz, cast(const(lxb_char_t)*) (begin), (data - begin) - 3); if (status != LXB_STATUS_OK) { return null; } } } while (0); do { if ((lxb_css_syntax_replacement_length) > 0) { lxb_status_t status = lxb_css_syntax_string_append(tkz, cast(const(lxb_char_t)*) ("\uFFFD"), lxb_css_syntax_replacement_length); if (status != LXB_STATUS_OK) { return null; } } } while (0); begin = data; }
                    continue;
                }
    ...
    while (data < end) {
        switch (*data) {
            ...
            default:
                ...
                if (*data >= 0x80) {
                    lxb_codepoint_t cp_m = lxb_css_syntax_state_decode_utf_8_up_80(&data, end); if (cp_m == LXB_CSS_SYNTAX_ERROR_CODEPOINT) { do { if ((data - begin) > 0) { lxb_status_t status = lxb_css_syntax_string_append(tkz, cast(const(lxb_char_t)*) (begin), data - begin); if (status != LXB_STATUS_OK) { return null; } } } while (0); do { if ((lxb_css_syntax_replacement_length) > 0) { lxb_status_t status = lxb_css_syntax_string_append(tkz, cast(const(lxb_char_t)*) ("\uFFFD"), lxb_css_syntax_replacement_length); if (status != LXB_STATUS_OK) { return null; } } } while (0); data += 1; begin = data; } else if (cp_m >= 0xD800 && cp_m <= 0xDFFF) { do { if (((data - begin) - 3) > 0) { lxb_status_t status = lxb_css_syntax_string_append(tkz, cast(const(lxb_char_t)*) (begin), (data - begin) - 3); if (status != LXB_STATUS_OK) { return null; } } } while (0); do { if ((lxb_css_syntax_replacement_length) > 0) { lxb_status_t status = lxb_css_syntax_string_append(tkz, cast(const(lxb_char_t)*) ("\uFFFD"), lxb_css_syntax_replacement_length); if (status != LXB_STATUS_OK) { return null; } } } while (0); begin = data; }
                    continue;
                }
