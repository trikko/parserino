module parserino.lexbor.html.tree.insertion_mode.in_template;
 ...
 */
 bool lxb_html_tree_insertion_mode_in_template_ct(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
 ...
 bool lxb_html_tree_insertion_mode_in_template_col(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
    lxb_html_tree_template_insertion_pop(tree);
 ...
 bool lxb_html_tree_insertion_mode_in_template_tr(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
    lxb_html_tree_template_insertion_pop(tree);
 ...
 * "td", "th"
 */
 bool lxb_html_tree_insertion_mode_in_template_tdth(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
    lxb_html_tree_template_insertion_pop(tree);
 ...
 bool lxb_html_tree_insertion_mode_in_template_end_of_file(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
 ...
 bool lxb_html_tree_insertion_mode_in_template_anything_else(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
    lxb_html_tree_template_insertion_pop(tree);
