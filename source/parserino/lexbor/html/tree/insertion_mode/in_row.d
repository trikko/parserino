module parserino.lexbor.html.tree.insertion_mode.in_row;
...
private void lxb_html_tree_clear_stack_back_to_table_row(lxb_html_tree_t* tree)
{
 ...
 * "th", "td"
 */
 bool lxb_html_tree_insertion_mode_in_row_thtd(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
 ...
 bool lxb_html_tree_insertion_mode_in_row_tr_closed(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
 ...
 */
 bool lxb_html_tree_insertion_mode_in_row_ct_open_closed(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
    lxb_dom_node_t* node = void;
 ...
 * "tbody", "tfoot", "thead"
 */
 bool lxb_html_tree_insertion_mode_in_row_tbtfth_closed(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
    lxb_dom_node_t* node = void;
 ...
 */
 bool lxb_html_tree_insertion_mode_in_row_bcht_closed(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
    lxb_html_tree_parse_error(tree, token, LXB_HTML_RULES_ERROR_UNCLTO);
 ...
 bool lxb_html_tree_insertion_mode_in_row_anything_else(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
    return lxb_html_tree_insertion_mode_in_table(tree, token);
}

 bool lxb_html_tree_insertion_mode_in_row_anything_else_closed(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
