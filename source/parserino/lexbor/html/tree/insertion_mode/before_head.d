module parserino.lexbor.html.tree.insertion_mode.before_head;
...
private bool lxb_html_tree_insertion_mode_before_head_open(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
    switch (token.tag_id) {
...
private bool lxb_html_tree_insertion_mode_before_head_closed(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
    switch (token.tag_id) {
        case LXB_TAG_HEAD:
        case LXB_TAG_BODY:
 ...
 bool lxb_html_tree_insertion_mode_before_head_anything_else(lxb_html_tree_t* tree)
{
 ...
 lxb_status_t lxb_html_tree_insertion_mode_before_head_head(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
    ...
    tree.document.head = (cast(lxb_html_head_element_t*) (element));
