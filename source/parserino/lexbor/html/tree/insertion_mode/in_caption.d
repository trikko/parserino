module parserino.lexbor.html.tree.insertion_mode.in_caption;
 ...
 */
 ...
 bool lxb_html_tree_insertion_mode_in_caption_caption_closed(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
 ...
 */
 bool lxb_html_tree_insertion_mode_in_caption_ct_open_closed(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
    lxb_dom_node_t* node = void;
 ...
 * "tr"
 */
 bool lxb_html_tree_insertion_mode_in_caption_bcht_closed(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
 ...
 bool lxb_html_tree_insertion_mode_in_caption_anything_else(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
    return lxb_html_tree_insertion_mode_in_body(tree, token);
}

 bool lxb_html_tree_insertion_mode_in_caption_anything_else_closed(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
