module parserino.lexbor.html.tree.insertion_mode.in_column_group;
 ...
 */
 ...
 bool lxb_html_tree_insertion_mode_in_column_group_anything_else(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
 ...
 bool lxb_html_tree_insertion_mode_in_column_group_text(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
 ...
 bool lxb_html_tree_insertion_mode_in_column_group_comment(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
 ...
 bool lxb_html_tree_insertion_mode_in_column_group_html(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
 ...
 bool lxb_html_tree_insertion_mode_in_column_group_col(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
 ...
 bool lxb_html_tree_insertion_mode_in_column_group_colgroup_closed(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
    lxb_dom_node_t* node = lxb_html_tree_current_node(tree);
 ...
 bool lxb_html_tree_insertion_mode_in_column_group_col_closed(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
 ...
 bool lxb_html_tree_insertion_mode_in_column_group_template_open_closed(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
    return lxb_html_tree_insertion_mode_in_head(tree, token);
}

 bool lxb_html_tree_insertion_mode_in_column_group_end_of_file(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
    return lxb_html_tree_insertion_mode_in_body(tree, token);
}

 bool lxb_html_tree_insertion_mode_in_column_group_anything_else_closed(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
