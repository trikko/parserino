module parserino.lexbor.html.tree.insertion_mode.in_head_noscript;
...
private bool lxb_html_tree_insertion_mode_in_head_noscript_open(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
    switch (token.tag_id) {
...
private bool lxb_html_tree_insertion_mode_in_head_noscript_closed(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
 ...
 bool lxb_html_tree_insertion_mode_in_head_noscript_anything_else(lxb_html_tree_t* tree, lxb_html_token_t* token)
{
    lxb_html_tree_parse_error(tree, token,
                              LXB_HTML_RULES_ERROR_UNTO);
