module parserino.lexbor.html.interfaces.style_element;
...
{
    lxb_html_style_element_t* element = void;

    element = cast(lxb_html_style_element*) lexbor_mraw_calloc(document.dom_document.mraw,
                                 lxb_html_style_element_t.sizeof);
    if (element == null) {
        return null;
    }
...
{
    cast(void) lxb_dom_node_interface_destroy((cast(lxb_dom_node_t*) (style_element)));
