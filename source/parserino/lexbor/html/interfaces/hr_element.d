module parserino.lexbor.html.interfaces.hr_element;
...
{
    lxb_html_hr_element_t* element = void;

    element = cast(lxb_html_hr_element*) lexbor_mraw_calloc(document.dom_document.mraw,
                                 lxb_html_hr_element_t.sizeof);
    if (element == null) {
        return null;
    }
...
{
    cast(void) lxb_dom_node_interface_destroy((cast(lxb_dom_node_t*) (hr_element)));
    return null;
}
