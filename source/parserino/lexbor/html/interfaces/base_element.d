module parserino.lexbor.html.interfaces.base_element;
...
{
    lxb_html_base_element_t* element = void;

    element = cast(lxb_html_base_element*) lexbor_mraw_calloc(document.dom_document.mraw,
                                 lxb_html_base_element_t.sizeof);
    if (element == null) {
        return null;
    }
...
lxb_html_base_element_t* lxb_html_base_element_interface_destroy(lxb_html_base_element_t* base_element)
{
    cast(void) lxb_dom_node_interface_destroy((cast(lxb_dom_node_t*) (base_element)));
    return null;
}
