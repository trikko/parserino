module parserino.lexbor.html.interfaces.form_element;
...
{
    lxb_html_form_element_t* element = void;

    element = cast(lxb_html_form_element*) lexbor_mraw_calloc(document.dom_document.mraw,
                                 lxb_html_form_element_t.sizeof);
    if (element == null) {
        return null;
    }
...
{
    cast(void) lxb_dom_node_interface_destroy((cast(lxb_dom_node_t*) (form_element)));
    return null;
}
